...
/*
  ...
  - Section subtitle: ink-600, 14px — subordinate metadata, passes WCAG AA
  - "See more" link: coral with arrow, right-aligned
  - Divider between sections: handled by the parent page (section-divider class)
*/
export default function FeaturedSection({ title, subtitle, entries, browseLink, browseLinkLabel = 'See more' }: FeaturedSectionProps) {
    ...
    <section className="py-10">
      <div className="flex items-end justify-between mb-6 gap-4">
        <div>
          ...
          <h2
            className="font-display font-bold text-2xl sm:text-3xl leading-tight text-ink-900"
        ...
        {browseLink && (
          <Link
            href={browseLink}
            className="shrink-0 text-sm font-semibold text-brand-coral hover:underline transition-colors duration-150"
          >
